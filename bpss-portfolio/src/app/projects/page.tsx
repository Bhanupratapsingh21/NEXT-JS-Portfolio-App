            ...
            <div className="max-w-7xl mx-auto py-28 px-4 sm:px-10 lg:px-16">
                <div>
                    <div className="text-center my-3">
                        <h2 className="text-3xl bg-clip-text text-transparent h-14 drop-shadow-2xl bg-gradient-to-b from-white/80 to-white/20 font-bold tracking-tighter text-left sm:text-4xl md:text-5xl">Project's</h2>
                    </div>
