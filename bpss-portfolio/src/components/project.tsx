            ...
            <div className=" w-[90vw] md:pt-24  mx-auto antialiased relative">
                ...
                <div>
                    <div className="grid overflow-hidden md:pr-6  grid-cols-1 mt-16 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
                        <Link className="col-span-1 lg:col-span-2 h-full" href={"/projects/1"}>
                            <WobbleCard
                        ...
                        <Link href={"project/3"} className="col-span-1 lg:col-span-3 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
                        ...
                        <Link className="col-span-1 lg:col-span-2 h-full" href={"/project/5"}>
                            <WobbleCard
                                containerClassName="col-span-1 lg:col-span-2 h-full bg-pink-800 min-h-[500px] lg:min-h-[300px]"
                                className=""
                            >
